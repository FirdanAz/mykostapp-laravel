...
@section('breadcrumb') <span class="mx-1">/</span> <a href="{{ route('admin.complaints.index') }}" class="hover:text-slate-600">Keluhan</a> <span class="mx-1">/</span> Catat Baru @endsection

@section('content')
<div class="max-w-2xl">
<form method="POST" action="{{ route('admin.complaints.store') }}" enctype="multipart/form-data" class="space-y-5">
    @csrf
    ...
    <div class="flex gap-3">
        ...
        <a href="{{ route('admin.complaints.index') }}" class="px-6 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-sm rounded-xl transition-colors">
            Batal
        </a>
    </div>
</form>
