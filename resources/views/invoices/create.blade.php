...
@section('breadcrumb') <span class="mx-1">/</span> <a href="{{ route('invoices.index') }}" class="hover:text-slate-600">Tagihan</a> <span class="mx-1">/</span> Buat Baru @endsection
...
<form method="POST" action="{{ route('invoices.store') }}" class="space-y-5">
    ...
    <div class="flex gap-3">
        ...
        <a href="{{ route('invoices.index') }}" class="px-6 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-sm rounded-xl transition-colors">
            Batal
        </a>
    </div>
</form>
