...
@section('breadcrumb') <span class="mx-1">/</span> <a href="{{ route('admin.rooms.index') }}" class="hover:text-slate-600">Kamar</a> <span class="mx-1">/</span> {{ $room->number }} @endsection
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-5">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6">
            ...
            <div class="space-y-3">
                ...
                <a href="{{ route('admin.tenants.show', $tenant) }}" class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors">
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-5 space-y-2.5">
            ...
            @endif
            <form method="POST" action="{{ route('admin.rooms.destroy', $room) }}" onsubmit="return confirm('Yakin hapus kamar ini?')">
                @csrf @method('DELETE')
        ...
        <div class="bg-blue-50 rounded-2xl border border-blue-200 p-5">
            ...
            <a href="{{ route('admin.tenants.show', $room->activeTenant) }}"
